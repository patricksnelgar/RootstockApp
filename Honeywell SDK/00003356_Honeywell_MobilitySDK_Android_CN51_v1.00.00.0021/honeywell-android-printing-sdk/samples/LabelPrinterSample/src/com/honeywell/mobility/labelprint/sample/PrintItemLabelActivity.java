...
/**
 * This activity allows you to print a label containing the item name text,
 * the item number barcode and text.
 * <p>
 ...
 */
public class PrintItemLabelActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_print_item_label);

		editItemName = (EditText) findViewById(R.id.editItemName);
		// Sets a default item name.
		editItemName.setText("Honeywell AirGenius 4");

		editItemNumber = (EditText) findViewById(R.id.editItemNumber);
		// Sets a default item number.
		editItemNumber.setText("92926003104");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.print_item_label, menu);
		return true;
	}
	...
	public class PrintTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute()
		{
			...
			textMsg.setText("");
			sItemName = editItemName.getText().toString();
			sItemNo = editItemNumber.getText().toString();
		...
		protected String doInBackground(String... args)
		{
			...
			exSettings.setContext(PrintItemLabelActivity.this);
